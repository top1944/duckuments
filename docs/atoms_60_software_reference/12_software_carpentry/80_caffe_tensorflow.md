...
<div figure-id="fig:6" >
    <img src="6.png" style='width: 33em'/>
</div>


For testing our Python interface of Caffe works, we have to edit a file in `~/caffe/example`

    $ cd ~/caffe/examples/
    $ vim test_alexnet.py

And adding the following code into file:

<div figure-id="fig:7" >
    <img src="7.png" style='width: 33em'/>
</div>

Save, and excute it

    $ python test_alexnet.py

This will import Caffe from Python interface and predict the image `~/caffe/examples/images/cat.jpg` by forwarding Alexnet.

<div figure-id="fig:8" >
    <img src="8.png" style='width: 33em'/>
</div>
